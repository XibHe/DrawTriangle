...
- (void)viewDidLoad {
    ...
    _sourceArray = @[@"使用UIBezierPath绘制多边形",@"UIBezierPath+CAShapeLayer绘制多边形",@"CAShapeLayer设置Image",@"UIBezierPath绘制圆角Image",@"结合CGPathAddLineToPoint画三角",@"绘制带有箭头的矩形框",@"CGPathRef上绘制渐变颜色",@"结合CGPathAddArcToPoint绘制圆角矩形",@"结合CABasicAnimation做动画",@"二次贝塞尔曲线"];
